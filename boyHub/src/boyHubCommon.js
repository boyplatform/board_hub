...
const BoyHubHttpHelper=require('./boyHubHttpHelper');
...
var getCurrentServerPubIpAdress= function(callback){
   ...
   memoryNodeCache.get("myPubIp",function(err,value){
        ...
        {
           //不存在，请求远程IP查询地址并写入缓存
           BoyHubHttpHelper.apiSimpleRequestWithCallBack(conf.platformArch.crystalCluster.CheckSelfPubNetworkIpHttpMode,conf.platformArch.crystalCluster.CheckSelfPubNetworkIpDomainUrl,conf.platformArch.crystalCluster.CheckSelfPubNetworkIpPartialUrl,{},false,conf.platformArch.defaultHttpReqTimeOut,function(res){
